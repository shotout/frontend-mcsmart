...
export const STORE = {
  playstore: 'https://play.google.com/store/apps/details?id=com.mcsmart',
  appstore: 'https://apps.apple.com/us/app/mcsmart/id6443447216',
};
export const downloadText = `I found this fact on the McSmart App. Download now for the best quotes:\n\nPlaystore: ${STORE.playstore}\nAppstore: ${STORE.appstore}`;
